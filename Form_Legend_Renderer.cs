...
namespace GSC_Legend_Renderer
{
    public partial class Form_Legend_Renderer : Form
    {
        ...
        public Tuple<double, double> GetAnchorPointStart()
        {
            ...
            //Apply conversion factor
            double startWidth = currentDoc.ActiveView.Extent.Envelope.Width;
            double startHeight = currentDoc.ActiveView.Extent.Envelope.Height;
            ...
            {
                anchorCoord = new Tuple<double, double>(startWidth / 2.0, startHeight / 2.0);
